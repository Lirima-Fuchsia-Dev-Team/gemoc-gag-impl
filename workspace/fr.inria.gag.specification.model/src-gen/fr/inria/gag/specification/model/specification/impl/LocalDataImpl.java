 ...
 * </p>
 * <ul>
 *   <li>{@link fr.inria.gag.specification.model.specification.impl.LocalDataImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LocalDataImpl extends RighPartExpressionImpl implements LocalData {
	...
	protected EClass eStaticClass() {
		return SpecificationPackage.Literals.LOCAL_DATA;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SpecificationPackage.LOCAL_DATA__NAME, oldName,
					name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case SpecificationPackage.LOCAL_DATA__NAME:
			return getName();
		}
