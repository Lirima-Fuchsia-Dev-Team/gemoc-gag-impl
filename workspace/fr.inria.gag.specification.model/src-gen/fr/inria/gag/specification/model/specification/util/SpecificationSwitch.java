...
public class SpecificationSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case SpecificationPackage.GAG: {
			GAG gag = (GAG) theEObject;
			T result = caseGAG(gag);
			if (result == null)
		...
		case SpecificationPackage.SEMANTIC_RULE: {
			SemanticRule semanticRule = (SemanticRule) theEObject;
			T result = caseSemanticRule(semanticRule);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		...
		case SpecificationPackage.RUNTIME_DATA: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>GAG</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>GAG</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseGAG(GAG object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Semantic Rule</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Semantic Rule</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseSemanticRule(SemanticRule object) {
		return null;
	}
