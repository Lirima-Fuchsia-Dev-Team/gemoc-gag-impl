 ...
 * </p>
 * <ul>
 *   <li>{@link inria.fuchsia.gag.xdsml.gag.specification.impl.GAGImpl#getRule <em>Rule</em>}</li>
 *   <li>{@link inria.fuchsia.gag.xdsml.gag.specification.impl.GAGImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GAGImpl extends EObjectImpl implements GAG {
	/**
	...
	public EList<Rule> getRule() {
		if (rule == null) {
			rule = new EObjectContainmentEList<Rule>(Rule.class, this, SpecificationPackage.GAG__RULE);
		}
		return rule;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case SpecificationPackage.GAG__RULE:
