/**
 */
package inria.fuchsia.gag.gag.process.util;
 ...
 * <!-- end-user-doc -->
 * @see inria.fuchsia.gag.gag.process.ProcessPackage
 * @generated
 */
public class ProcessAdapterFactory extends AdapterFactoryImpl {
	...
	protected ProcessSwitch<Adapter> modelSwitch =
		new ProcessSwitch<Adapter>() {
			...
			@Override
			public Adapter caseProcess(inria.fuchsia.gag.gag.process.Process object) {
	...
	/**
	 * Creates a new adapter for an object of class '{@link inria.fuchsia.gag.gag.process.Task <em>Task</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link inria.fuchsia.gag.gag.process.Configuration <em>Configuration</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link inria.fuchsia.gag.gag.process.Process <em>Process</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
