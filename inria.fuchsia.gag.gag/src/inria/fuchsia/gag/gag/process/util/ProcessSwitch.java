...
public class ProcessSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case ProcessPackage.PROCESS: {
				inria.fuchsia.gag.gag.process.Process process = (inria.fuchsia.gag.gag.process.Process)theEObject;
	 ...
	 * @generated
	 */
	public T caseProcess(inria.fuchsia.gag.gag.process.Process object) {
		return null;
	}
