...
public class ConfigurationImpl extends EObjectImpl implements Configuration {
	...
	public NotificationChain basicSetRoot(Task newRoot, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ProcessPackage.CONFIGURATION__ROOT, oldRoot, newRoot);
	...
	public void setRoot(Task newRoot) {
		if (newRoot != root) {
			...
			if (root != null)
				msgs = ((InternalEObject)root).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ProcessPackage.CONFIGURATION__ROOT, null, msgs);
			if (newRoot != null)
				msgs = ((InternalEObject)newRoot).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ProcessPackage.CONFIGURATION__ROOT, null, msgs);
			msgs = basicSetRoot(newRoot, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.CONFIGURATION__ROOT, newRoot, newRoot));
	}
