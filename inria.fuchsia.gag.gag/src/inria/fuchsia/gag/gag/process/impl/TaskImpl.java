...
public class TaskImpl extends EObjectImpl implements Task {
	...
	/**
	 * The cached value of the '{@link #getAssociated_to() <em>Associated to</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public NotificationChain basicSetAssociated_to(Service newAssociated_to, NotificationChain msgs) {
		Service oldAssociated_to = associated_to;
		associated_to = newAssociated_to;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ProcessPackage.TASK__ASSOCIATED_TO, oldAssociated_to, newAssociated_to);
	...
	public void setAssociated_to(Service newAssociated_to) {
		if (newAssociated_to != associated_to) {
			NotificationChain msgs = null;
			if (associated_to != null)
				msgs = ((InternalEObject)associated_to).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ProcessPackage.TASK__ASSOCIATED_TO, null, msgs);
			if (newAssociated_to != null)
				msgs = ((InternalEObject)newAssociated_to).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ProcessPackage.TASK__ASSOCIATED_TO, null, msgs);
			msgs = basicSetAssociated_to(newAssociated_to, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.TASK__ASSOCIATED_TO, newAssociated_to, newAssociated_to));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ProcessPackage.TASK__ASSOCIATED_TO:
				return basicSetAssociated_to(null, msgs);
