...
public class GuardAdapter extends EObjectAdapter<Guard> implements inria.fuchsia.gag.xdsml.gagmt.specification.Guard {
  ...
  public EClass eClass() {
    return inria.fuchsia.gag.xdsml.gagmt.specification.SpecificationPackage.eINSTANCE.getGuard();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case inria.fuchsia.gag.xdsml.gagmt.specification.SpecificationPackage.GUARD__CLASS_PATH:
    		return getClassPath();
    }
