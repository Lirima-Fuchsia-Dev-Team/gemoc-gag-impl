...
public class GAGAdapter extends EObjectAdapter<GAG> implements inria.fuchsia.gag.xdsml.gagmt.specification.GAG {
  ...
  public void addRule(final Rule rule) {
    adaptee.addRule(((inria.fuchsia.gag.xdsml.gag.adapters.gagmt.specification.RuleAdapter) rule).getAdaptee()
    );
  }
  
  @Override
  public void removeRule(final Rule rule) {
    adaptee.removeRule(((inria.fuchsia.gag.xdsml.gag.adapters.gagmt.specification.RuleAdapter) rule).getAdaptee()
    );
  }
  ...
  public EClass eClass() {
    return inria.fuchsia.gag.xdsml.gagmt.specification.SpecificationPackage.eINSTANCE.getGAG();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case inria.fuchsia.gag.xdsml.gagmt.specification.SpecificationPackage.GAG__RULE:
    		return getRule();
    	case inria.fuchsia.gag.xdsml.gagmt.specification.SpecificationPackage.GAG__NAME:
    		return getName();
    }
