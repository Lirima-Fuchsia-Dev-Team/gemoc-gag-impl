...
import inria.fuchsia.gag.xdsml.GagMT;
...
public class GagAdapter extends ResourceAdapter implements GagMT {
  ...
  public ProcessFactory getProcessFactory() {
    return new inria.fuchsia.gag.xdsml.gag.adapters.gagmt.process.ProcessFactoryAdapter();
  }
  
  @Override
  public SpecificationFactory getSpecificationFactory() {
    return new inria.fuchsia.gag.xdsml.gag.adapters.gagmt.specification.SpecificationFactoryAdapter();
  }
