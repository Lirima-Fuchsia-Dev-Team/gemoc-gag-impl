...
public class ConfigurationAdapter extends EObjectAdapter<Configuration> implements inria.fuchsia.gag.xdsml.gagmt.process.Configuration {
  ...
  public void setRoot(final Task o) {
    if (o != null)
    	adaptee.setRoot(((inria.fuchsia.gag.xdsml.gag.adapters.gagmt.process.TaskAdapter) o).getAdaptee());
  ...
  public void setConsistent_to(final GAG o) {
    if (o != null)
    	adaptee.setConsistent_to(((inria.fuchsia.gag.xdsml.gag.adapters.gagmt.specification.GAGAdapter) o).getAdaptee());
  ...
  public EClass eClass() {
    return inria.fuchsia.gag.xdsml.gagmt.process.ProcessPackage.eINSTANCE.getConfiguration();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case inria.fuchsia.gag.xdsml.gagmt.process.ProcessPackage.CONFIGURATION__ROOT:
    		return getRoot();
    	case inria.fuchsia.gag.xdsml.gagmt.process.ProcessPackage.CONFIGURATION__NAME:
    		return getName();
    	case inria.fuchsia.gag.xdsml.gagmt.process.ProcessPackage.CONFIGURATION__CONSISTENT_TO:
  ...
  public void eSet(final int featureID, final Object newValue) {
    switch (featureID) {
    	case inria.fuchsia.gag.xdsml.gagmt.process.ProcessPackage.CONFIGURATION__ROOT:
    		setRoot(
    		(inria.fuchsia.gag.xdsml.gagmt.process.Task)
    		 newValue);
    		return;
    	case inria.fuchsia.gag.xdsml.gagmt.process.ProcessPackage.CONFIGURATION__NAME:
    		setName(
    	...
    	case inria.fuchsia.gag.xdsml.gagmt.process.ProcessPackage.CONFIGURATION__CONSISTENT_TO:
    		setConsistent_to(
    		(inria.fuchsia.gag.xdsml.gagmt.specification.GAG)
    		 newValue);
    		return;
    }
