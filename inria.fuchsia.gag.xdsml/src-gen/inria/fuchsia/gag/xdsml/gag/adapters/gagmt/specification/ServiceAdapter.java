...
public class ServiceAdapter extends EObjectAdapter<Service> implements inria.fuchsia.gag.xdsml.gagmt.specification.Service {
  ...
  public EClass eClass() {
    return inria.fuchsia.gag.xdsml.gagmt.specification.SpecificationPackage.eINSTANCE.getService();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case inria.fuchsia.gag.xdsml.gagmt.specification.SpecificationPackage.SERVICE__INPUT:
    		return getInput();
    	case inria.fuchsia.gag.xdsml.gagmt.specification.SpecificationPackage.SERVICE__OUTPUT:
    		return getOutput();
    	case inria.fuchsia.gag.xdsml.gagmt.specification.SpecificationPackage.SERVICE__NAME:
    		return getName();
    }
