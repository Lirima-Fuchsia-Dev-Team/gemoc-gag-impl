...
public class TaskAdapter extends EObjectAdapter<Task> implements inria.fuchsia.gag.xdsml.gagmt.process.Task {
  ...
  public Service getInstance_of() {
    return (Service) adaptersFactory.createAdapter(adaptee.getInstance_of(), eResource);
  }
  
  @Override
  public void setInstance_of(final Service o) {
    if (o != null)
    	adaptee.setInstance_of(((inria.fuchsia.gag.xdsml.gag.adapters.gagmt.specification.ServiceAdapter) o).getAdaptee());
    else adaptee.setInstance_of(null);
  }
  
  private EList<inria.fuchsia.gag.xdsml.gagmt.process.Task> sub_task_;
  
  @Override
  public EList<inria.fuchsia.gag.xdsml.gagmt.process.Task> getSub_task() {
    if (sub_task_ == null)
  ...
  public void applyRule(final Rule rule) {
    adaptee.applyRule(((inria.fuchsia.gag.xdsml.gag.adapters.gagmt.specification.RuleAdapter) rule).getAdaptee()
    );
  }
  ...
  public EClass eClass() {
    return inria.fuchsia.gag.xdsml.gagmt.process.ProcessPackage.eINSTANCE.getTask();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case inria.fuchsia.gag.xdsml.gagmt.process.ProcessPackage.TASK__ID:
    		return new java.lang.Long(getId());
    	case inria.fuchsia.gag.xdsml.gagmt.process.ProcessPackage.TASK__NAME:
    		return getName();
    	case inria.fuchsia.gag.xdsml.gagmt.process.ProcessPackage.TASK__IS_OPEN:
    		return isIs_open() ? Boolean.TRUE : Boolean.FALSE;
    	case inria.fuchsia.gag.xdsml.gagmt.process.ProcessPackage.TASK__APPLIED_RULE:
    		return getAppliedRule();
    	case inria.fuchsia.gag.xdsml.gagmt.process.ProcessPackage.TASK__INSTANCE_OF:
    		return getInstance_of();
    	case inria.fuchsia.gag.xdsml.gagmt.process.ProcessPackage.TASK__SUB_TASK:
    		return getSub_task();
    }
