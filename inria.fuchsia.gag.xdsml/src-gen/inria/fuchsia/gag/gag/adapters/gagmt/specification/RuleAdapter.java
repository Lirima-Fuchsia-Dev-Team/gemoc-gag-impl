...
public class RuleAdapter extends EObjectAdapter<Rule> implements inria.fuchsia.gag.gagmt.specification.Rule {
  ...
  public void setLeft_hand_side(final Service o) {
    if (o != null)
    	adaptee.setLeft_hand_side(((inria.fuchsia.gag.gag.adapters.gagmt.specification.ServiceAdapter) o).getAdaptee());
  ...
  public void setGuard(final Guard o) {
    if (o != null)
    	adaptee.setGuard(((inria.fuchsia.gag.gag.adapters.gagmt.specification.GuardAdapter) o).getAdaptee());
  ...
  public EClass eClass() {
    return inria.fuchsia.gag.gagmt.specification.SpecificationPackage.eINSTANCE.getRule();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case inria.fuchsia.gag.gagmt.specification.SpecificationPackage.RULE__LEFT_HAND_SIDE:
    		return getLeft_hand_side();
    	case inria.fuchsia.gag.gagmt.specification.SpecificationPackage.RULE__NAME:
    		return getName();
    	case inria.fuchsia.gag.gagmt.specification.SpecificationPackage.RULE__PARAMETERS:
    		return getParameters();
    	case inria.fuchsia.gag.gagmt.specification.SpecificationPackage.RULE__RIGHT_HAND_SIDE_SERVICE:
    		return getRight_hand_side_service();
    	case inria.fuchsia.gag.gagmt.specification.SpecificationPackage.RULE__GUARD:
    		return getGuard();
    }
  ...
  public void eSet(final int featureID, final Object newValue) {
    switch (featureID) {
    	...
    	case inria.fuchsia.gag.gagmt.specification.SpecificationPackage.RULE__GUARD:
    		setGuard(
    		(inria.fuchsia.gag.gagmt.specification.Guard)
    		 newValue);
    		return;
    }
