/**
 */
package inria.fuchsia.gag.gagmt.specification.impl;

import inria.fuchsia.gag.gagmt.process.ProcessPackage;

import inria.fuchsia.gag.gagmt.process.impl.ProcessPackageImpl;
...
public class SpecificationPackageImpl extends EPackageImpl implements SpecificationPackage {
	 ...
	 * @see inria.fuchsia.gag.gagmt.specification.SpecificationPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public void initializePackageContents() {
		...
		initEClass(gagEClass, inria.fuchsia.gag.gagmt.specification.GAG.class, "GAG", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getGAG_Rule(), this.getRule(), null, "rule", null, 1, -1, inria.fuchsia.gag.gagmt.specification.GAG.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getGAG_Name(), ecorePackage.getEString(), "name", null, 1, 1, inria.fuchsia.gag.gagmt.specification.GAG.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
