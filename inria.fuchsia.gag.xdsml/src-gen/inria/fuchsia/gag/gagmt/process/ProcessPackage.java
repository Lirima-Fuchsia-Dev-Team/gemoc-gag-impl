...
public interface ProcessPackage extends EPackage {
	...
	/**
	 * The meta object id for the '{@link inria.fuchsia.gag.gagmt.process.impl.ProcessImpl <em>Process</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see inria.fuchsia.gag.gagmt.process.impl.ProcessImpl
	 * @see inria.fuchsia.gag.gagmt.process.impl.ProcessPackageImpl#getProcess()
	 * @generated
	 */
	int PROCESS = 2;
	...
	/**
	 * Returns the meta object for the containment reference '{@link inria.fuchsia.gag.gagmt.process.Task#getAssociated_to <em>Associated to</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Returns the meta object for the containment reference '{@link inria.fuchsia.gag.gagmt.process.Configuration#getRoot <em>Root</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Returns the meta object for class '{@link inria.fuchsia.gag.gagmt.process.Process <em>Process</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>Process</em>'.
	 * @see inria.fuchsia.gag.gagmt.process.Process
	 * @generated
	 */
	EClass getProcess();

	/**
	 * Returns the meta object for the containment reference '{@link inria.fuchsia.gag.gagmt.process.Process#getConfiguration <em>Configuration</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference '<em>Configuration</em>'.
	 * @see inria.fuchsia.gag.gagmt.process.Process#getConfiguration()
	 * @see #getProcess()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for the containment reference '{@link inria.fuchsia.gag.gagmt.process.Process#getSpecification <em>Specification</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference '<em>Specification</em>'.
	 * @see inria.fuchsia.gag.gagmt.process.Process#getSpecification()
	 * @see #getProcess()
	 * @generated
	 */
	...
	interface Literals {
		...
		/**
		 * The meta object literal for the '{@link inria.fuchsia.gag.gagmt.process.impl.ProcessImpl <em>Process</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see inria.fuchsia.gag.gagmt.process.impl.ProcessImpl
		 * @see inria.fuchsia.gag.gagmt.process.impl.ProcessPackageImpl#getProcess()
