...
public class ProcessSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case ProcessPackage.PROCESS: {
				inria.fuchsia.gag.gagmt.process.Process process = (inria.fuchsia.gag.gagmt.process.Process)theEObject;
	 ...
	 * @generated
	 */
	public T caseProcess(inria.fuchsia.gag.gagmt.process.Process object) {
		return null;
	}
