/**
 */
package inria.fuchsia.gag.gagmt.process.util;
...
public class ProcessAdapterFactory extends AdapterFactoryImpl {
	...
	protected ProcessSwitch<Adapter> modelSwitch =
		new ProcessSwitch<Adapter>() {
			...
			@Override
			public Adapter caseProcess(inria.fuchsia.gag.gagmt.process.Process object) {
	...
	/**
	 * Creates a new adapter for an object of class '{@link inria.fuchsia.gag.gagmt.process.Task <em>Task</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link inria.fuchsia.gag.gagmt.process.Configuration <em>Configuration</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link inria.fuchsia.gag.gagmt.process.Process <em>Process</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
